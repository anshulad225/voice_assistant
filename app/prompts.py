GUARDRAIL_KEYWORDS = {
    "booking": ["appointment", "schedule", "book", "availability", "slot", "cancel", "reschedule"],
    "clinical": ["pain", "emergency", "diagnosis", "treatment", "symptoms", "medication", "prescription", "dental", "tooth", "teeth", "cavity", "root canal", "extraction"],
    "pricing": ["cost", "price", "fee", "insurance", "payment", "billing", "charge", "discount"],
}
...
Step 1: Call the save_patient_data function with the caller's name, reason, and patient ID.
...
- Never call save_patient_data until the caller has explicitly confirmed YES.
